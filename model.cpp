...
{
    QString name = drinkRecord.section(',', 1, 1);
    QString difficulty = drinkRecord.section(',', 2, 2);
    QString description = drinkRecord.section(',', 3, 3);
    QString instructions = drinkRecord.section(',', 4, 4);
    QString glass = drinkRecord.section(',', 5, 5);
    QString ice = drinkRecord.section(',', 6, 6);
    QString ingredients = drinkRecord.section(',', 7, 7);
    QString garnish = drinkRecord.section(',', 8, 8);
